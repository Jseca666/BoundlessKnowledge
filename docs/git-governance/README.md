...
每轮重要变更都按状态快照、范围归类、协同校验、本地提交、远端授权门、动作后记录来运行。长期规则见 `system/git-governance-system.json#cycle_management`；闭环状态见 `system/system-closure-map.json#modules.git-governance`。
